...
import { LOGIN_KEY, DATA_KEY, ORIGIN_KEY } from '../constant/constant.js'
...
export function getOriginSessionStorage(){
    return getSessionStorage(ORIGIN_KEY);
}

export function setOriginSessionStorage(userName){
    setSessionStorage(userName, ORIGIN_KEY);
}

export function clearOriginSessionStorage(){
    clearSessionStorage(ORIGIN_KEY);
}